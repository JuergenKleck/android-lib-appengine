...
public class ColorPickDialog extends AlertDialog {
    ...
    public interface OnColorSelectedListener {
         ...
         *              possible if {@link ColorPickDialog#setNoColorButton(int) setNoColorButton()}
         *              has been called on the dialog before showing it
         */
        public void colorSelected(Integer color);
    }

    public ColorPickDialog(Context context, final OnColorSelectedListener listener) {
        this(context, Color.BLACK, listener);
    }

    public ColorPickDialog(Context context, int initialColor, final OnColorSelectedListener listener) {
        super(context);
